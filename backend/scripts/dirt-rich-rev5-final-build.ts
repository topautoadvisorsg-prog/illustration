/**
 * DIRT RICH Rev 5 — authoritative final interior.
 *
...
if (project.manuscriptSha256 !== REV5_SHA) {
  throw new Error(`production is not on Rev 5 (${project.manuscriptSha256})`);
}
...
const gates: Array<[string, boolean, string]> = [
  ...
  ['built from Rev 5', project.manuscriptSha256 === REV5_SHA, REV5_SHA.slice(0, 16)],
];
console.log('\nGATES');
