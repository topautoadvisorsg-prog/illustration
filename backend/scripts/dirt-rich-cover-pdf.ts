 ...
 *
 * This built an early DIRT RICH cover, before the book was retitled. It is kept so that artifact can be reproduced, and
...
const ART = 'C:/Users/jovan/Downloads/dirt-rich-cover/_artwork-no-author.APPROVED-BACKUP.png';
const INTERIOR = `${BOOK_DIR}/DIRT-RICH-INTERIOR-PRINT-READY.pdf`;
const OUT_PDF = `${BOOK_DIR}/DIRT-RICH-COVER-PRINT-READY.pdf`;
const OUT_PROOF = `${BOOK_DIR}/DIRT-RICH-COVER-proof.png`;
...
const SPINE_TITLE_PX = 76;
const SPINE_AUTHOR_PX = 52;
/**
