 ...
 *
 * Reason: superseded by seed-packet-cover-paperback.ts, which is the same program carrying the retitled book plus halo-aware spine measurement.
 *
...
const ART = 'C:/Users/jovan/Downloads/dirt rich book/COVER REV5 - new title/COVER-REV5-ARTWORK-raw.png';
const INTERIOR = `${BOOK_DIR}/DIRT-RICH-INTERIOR-FINAL.pdf`;
const OUT_PDF = `C:/Users/jovan/Downloads/dirt rich book/COVER REV5 - new title/COVER-REV5-PRINT.pdf`;
const OUT_PROOF = `C:/Users/jovan/Downloads/dirt rich book/COVER REV5 - new title/COVER-REV5-proof.png`;
