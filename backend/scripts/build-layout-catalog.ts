...
const families: Family[] = [
  ...
  { name: 'Title Page', layoutTemplate: 'LAYOUT_D_PURE_TEXT', pageRole: 'opener', section: 'FRONT_MATTER', frontMatterType: 'TITLE_PAGE', subject: '', body: '', purpose: 'Book title page — title/author typeset by the engine over an ornament.', whenSelected: 'Front matter.' },
