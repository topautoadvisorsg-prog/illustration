...
export const TRADE_NONFICTION_GUIDE_TYPESET_V2: TypesetLayoutStandard = {
  ...
  tables: {
    ...
    repeatHeader: false,
    /**
     * OFF. DIRT RICH is approved and printed against this standard, and its
     * Table C.1 is SEVEN columns — any threshold low enough to be useful would
     * restack the most-consulted page of a book that has already shipped.
     *
     * The wide-table fallback is opt-in per standard for exactly this reason. A
     * book that needs it registers a standard that turns it on.
     */
